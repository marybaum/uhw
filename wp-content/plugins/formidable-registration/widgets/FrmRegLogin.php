...
?>
	...
	<p><label for="<?php echo $this->get_field_id('label_username'); ?>"><?php _e('Username Label', 'frmreg') ?>:</label></p>
	<p><input type="text" class="widefat" id="<?php echo $this->get_field_id('label_username'); ?>" name="<?php echo $this->get_field_name('label_username'); ?>" value="<?php echo esc_attr( stripslashes($instance['label_username']) ); ?>" /></p>
	
	<p><label for="<?php echo $this->get_field_id('label_password'); ?>"><?php _e('Password Label', 'frmreg') ?>:</label></p>
	<p><input type="text" class="widefat" id="<?php echo $this->get_field_id('label_password'); ?>" name="<?php echo $this->get_field_name('label_password'); ?>" value="<?php echo esc_attr( stripslashes($instance['label_password']) ); ?>" /></p>
	
	<p><label for="<?php echo $this->get_field_id('label_remember'); ?>"><?php _e('Remember Me Label', 'frmreg') ?>:</label></p>
  <p><input type="text" class="widefat" id="<?php echo $this->get_field_id('label_remember'); ?>" name="<?php echo $this->get_field_name('label_remember'); ?>" value="<?php echo esc_attr( stripslashes($instance['label_remember']) ); ?>" /></p>
