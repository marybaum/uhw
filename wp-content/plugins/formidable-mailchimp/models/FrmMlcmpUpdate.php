...
class FrmMlcmpUpdate{
    ...
    function FrmMlcmpUpdate(){
        if(!class_exists('FrmUpdatesController') and !class_exists('FrmUpdate')) return;
        
        // Where all the vitals are defined for this plugin
        $this->plugin_nicename      = 'formidable-mailchimp';
        $this->plugin_name          = 'formidable-mailchimp/formidable-mailchimp.php';
        $this->pro_last_checked_store = 'frm_mlcmp_last_checked_update';
